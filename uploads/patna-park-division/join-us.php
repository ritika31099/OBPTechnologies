            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="join-us-img">
                        <img src="img/join-us-img.png" alt="join-us-img">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="contact-form-area">
                    <div class="ribbon">
                        <span class="ribbon1"><span>Join Us</span></span>
                    </div>
                    <form class="contact-us-form">
                        <div class="form-group col-md-12 px-0">
                            <label for="exampleFormControlSelect1">How can you help us?</label>
                            <select class="form-control complain-form-control-select1" name="complaint-type" id="exampleFormControlSelect1" required="">
                                <option value="feedback">Voluteer</option>
                                <option value="donate">Donate a Plant</option><option value="adopt">Adopt a Tree</option>
