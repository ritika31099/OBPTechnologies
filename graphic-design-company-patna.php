...
<head>
  ...
  <title>Best Graphics and Logo Designing company in Patna - OBP Technologies</title>
  <meta name="description" content="OBP Technologies offer the best Graphic & logo design service in Patna. Offering Branding, social media post, brochure design, letterhead design etc." />
  <link rel="canonical" href="https://www.obptechnologies.com/graphic-design-company-patna.php" />
...
<section class="contact-sec" >
    <h1 class="Orange-headings" style="margin-top: .5em; "><strong>Graphic Designing Company</strong></h1>
                <h2 style="margin-top: -10px;  font-family: 'Times New Roman', serif; color: black;">Creating Beautiful Designs</h2>
                <img src="images/divider-light_blue.png" width="100px"></center>
        <div class="container">
            <div class="row">
          
            <div class="col-lg-8" style="padding: 10px; margin: 0px;">
                Organisations and industries are usually well aware of their brand personality throughout the market, so all the business personnel, as well as the corporate sector, are very much interested in graphics and logo designing which explains the quality of the products and other offerings of the company. It helps to earn the confidence of the people and establishes the unique identity of the organisation. People recall the company’s brand because they had an impression of the corporate logo. It gives an advantage to a company in the advertising of its goods and services and encourages it to attract more customers. So if you are searching for a graphics designing company in Patna, then OBP Technologies are the best option for you. It is the best graphics and logo designing company in Patna which offers attractive and unique graphic design and logo design at a reasonable cost.
<br><br>
<b>OUR GOAL-</b> We specialise in making a logo that will create a good impact upon the mind of the people about your company and it is vital for giving a total view of the company at one glance. Our designed logos and graphics are unique, original, colourful and are not made in violation of the copyright act.
<br><br>
<b>PRINCIPLES FOLLOWED BY US-</b> We follow the below-mentioned principles for making a wide variety of logo:
                <br>
                <br>
                 <ul>
                <li>Simplicity</li>
